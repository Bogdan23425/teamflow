...
export const BoardsHeader: React.FC<BoardsHeaderProps> = ({
  ...
  return (
    <motion.header
      ...
      className="relative flex flex-col gap-3 md:flex-row md:items-center md:justify-between py-2"
    >
      <div className="space-y-1.5">
        <p className="inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.18em] text-primary">
